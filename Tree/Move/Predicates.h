...
template<typename, typename Board> bool is_sequential_capture_removal(const Node::Position<Board>&, const Node::Pieces&);
template<typename Board> bool is_sequential_capture_removal(const Node::Position<Board>&, const Node::Pieces&, Int2Type<Variants::REMOVE_1>);
template<typename Board> bool is_sequential_capture_removal(const Node::Position<Board>&, const Node::Pieces&, Int2Type<Variants::REMOVE_N>);
