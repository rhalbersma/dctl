...
using Ktar12        = Board< grid::Dimensions<12, 10, true>, 1, -90_deg >;      // fits within 64-bits
using Ktar12R       = Board< grid::Dimensions<12, 10, true> >;
using Ktar1012F     = Board< grid::Dimensions<10, 12>, 1 >;                     // fits within 64-bits
using Ktar1012      = Board< grid::Dimensions<10, 12, true> >;                  // same coloring as Canadian
