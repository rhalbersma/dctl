...
#include <dctl/grid/edge.hpp>          // Edge
...
using Frisian = Board< grid::Dimensions<10, 10>, grid::DoubleColumnEdge >;
...
using Ktar11 = Board< grid::Dimensions<11, 10, true>, grid::SingleColumnEdge >;
using Ktar12 = Board< grid::Dimensions<12, 10, true>, grid::Edge<1, angle::R090> >;
