...
public:
        ...
        {
                return
                        Weight<Rules, Board>::material[0] * static_cast<int>(p.pieces(Color).count()) +
                        Weight<Rules, Board>::material[1] * static_cast<int>(p.kings(Color).count())
                ;
        }
        ...
        {
                return Weight<Rules, Board>::mobility * static_cast<int>(successor::mobility<Color>(p));
        }
};
