...
[[nodiscard]] constexpr auto is_off_board_pieces(Set const& occupied) noexcept
{
        return !(occupied - basic_mask<Board>::squares).empty();
}

template<class Board, class Set>
[[nodiscard]] constexpr auto is_promoted_pawns(Set const& black_pawns, Set const& white_pawns) noexcept
{
...
template<class Set>
[[nodiscard]] constexpr auto is_overlapping_pieces(Set const& black_pawns, Set const& white_pawns, Set const& black_kings, Set const& white_kings) noexcept
{
        return
...
template<class Set>
[[nodiscard]] constexpr auto is_overlapping_pieces(Set const& black_pawns, Set const& white_pawns) noexcept
{
        return black_pawns.intersects(white_pawns);
}

template<class Board, class Set>
[[nodiscard]] constexpr auto is_legal(Set const& black_pawns, Set const& white_pawns, Set const& black_kings, Set const& white_kings) noexcept
{
        return
...
template<class Board, class Set>
[[nodiscard]] constexpr auto is_legal(Set const& black_pawns, Set const& white_pawns) noexcept
{
        return
