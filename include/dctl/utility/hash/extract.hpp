...
struct UpperBits
{
        ...
        {
                static_assert(std::is_integral<Index>{},       "Bitwise shift only applicable to integral types.");
                static_assert(std::is_integral<result_type>{}, "Bitwise shift only applicable to integral types.");
