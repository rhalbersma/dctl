...
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate(const Position<Board>& p, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate(const Position<Board>& p, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<true>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<false>)
{
        generate_serial(p.kings(Color), capture, move_stack);
}

template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_serial(BitBoard active_kings, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::DIRS_ALL>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::DIRS_ORTH>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::DIRS_DIAG>)
{
...
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_dir(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::generate_next(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::promote_en_passant(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::RANGE_1>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::RANGE_N>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_long(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_long(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<false>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_long(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<true>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_reverse(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
        return scan_dir<board::Rotate<Int2Type<Index>, board::Angle::D180>::value>(jumper, capture, move_stack);
}

template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_forward(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::SCAN_ALL>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::SCAN_REST>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack, Int2Type<rules::SCAN_SIDE>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan_dir(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
        king_slide<Index>(jumper, capture.template path<Index>());
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::scan(BitBoard jumper, capture::State<Rules, Board>& capture, Stack& move_stack)
{
        if (jumper & capture.template targets<Index>()) {
                capture.make(jumper);
                generate_next<Index>(jumper, capture, move_stack);
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::king_slide(BitBoard& jumper, BitBoard path)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::king_slide(BitBoard& jumper, BitBoard, Int2Type<rules::RANGE_1>)
{
        PushAssign<Board, Index>()(jumper);
}
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, Pieces::KING, JUMPS, Rules, Board>::king_slide(BitBoard& jumper, BitBoard path, Int2Type<rules::RANGE_N>)
{
        do PushAssign<Board, Index>()(jumper); while (jumper & path);
}

template<bool Color, typename Rules, typename Board>
size_t Driver<Color, Pieces::KING, JUMPS, Rules, Board>::count(const Position<Board>& p)
{
        Stack move_stack;
...
template<bool Color, typename Rules, typename Board>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect(const Position<Board>& p)
{
...
// tag dispatching based on king capture directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied)
{
...
// partial specialization for kings that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::DIRS_ALL>)
{
        return (
...
// partial specialization for kings that capture in the 4 orthogonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::DIRS_ORTH>)
{
        return (
...
// partial specialization for kings that capture in the 4 diagonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::DIRS_DIAG>)
{
        return (
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::RANGE_1>)
{
        return !bit::is_zero(
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, Pieces::KING, JUMPS, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::RANGE_N>)
{
        return !bit::is_zero(
