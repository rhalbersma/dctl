...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, node::Stack& move_stack, Int2Type<rules::DIRS_ALL>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>& capture, node::Stack& move_stack, Int2Type<rules::RANGE_1>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>& capture, node::Stack& move_stack, Int2Type<rules::RANGE_N>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>& capture, node::Stack& move_stack, Int2Type<rules::SCAN_ALL>)
{
        return (
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::king_slide(BitBoard& jumper, BitBoard, Int2Type<rules::RANGE_1>)
{
        PushAssign<Board, Index>()(jumper);
}
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::king_slide(BitBoard& jumper, BitBoard path, Int2Type<rules::RANGE_N>)
{
...
// partial specialization for kings that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::DIRS_ALL>)
{
        return (
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::RANGE_1>)
{
        return !bit::is_zero(
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::KING, node::JUMPS, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<rules::RANGE_N>)
{
        return !bit::is_zero(
