...
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, node::Pieces::KING, node::MOVES, Rules, Board>::generate_dir(BitBoard from_sq, BitBoard not_occupied, node::Stack& move_stack, Int2Type<rules::RANGE_1>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Driver<Color, node::Pieces::KING, node::MOVES, Rules, Board>::generate_dir(BitBoard from_sq, BitBoard not_occupied, node::Stack& move_stack, Int2Type<rules::RANGE_N>)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
size_t Driver<Color, node::Pieces::KING, node::MOVES, Rules, Board>::count_dir(BitBoard active_kings, BitBoard not_occupied, Int2Type<rules::RANGE_1>)
{
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index>
size_t Driver<Color, node::Pieces::KING, node::MOVES, Rules, Board>::count_dir(BitBoard active_kings, BitBoard not_occupied, Int2Type<rules::RANGE_N>)
{
