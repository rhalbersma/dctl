...
private:
        ...
        template<size_t> static void generate_dir(BitBoard, BitBoard, node::Stack&, Int2Type<rules::RANGE_1>);
        template<size_t> static void generate_dir(BitBoard, BitBoard, node::Stack&, Int2Type<rules::RANGE_N>);
