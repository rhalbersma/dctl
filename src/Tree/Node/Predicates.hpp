...
template<typename Board>
bool is_reversible(const Position<Board>& p, const Pieces& m)
{
...
template<typename Board>
bool is_intersecting_capture(const Position<Board>& p, const Pieces& m, Int2Type<rules::REMOVE_1>)
{
...
template<typename Board>
bool is_intersecting_capture(const Position<Board>&, const Pieces&, Int2Type<rules::REMOVE_N>)
{
        return false;
}
