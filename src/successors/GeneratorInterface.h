...
public:
        ...
        void generate_non_captures(const Position<Board>&, Stack&) const;
        ...
        int count_non_captures(const Position<Board>&) const;
        ...
        bool detect_non_captures(const Position<Board>&) const;
...
private:
        ...
        virtual void do_generate_non_captures(const Position<Board>&, Stack&) const = 0;
        ...
        virtual int do_count_non_captures(const Position<Board>&) const = 0;
        ...
        virtual bool do_detect_non_captures(const Position<Board>&) const = 0;
