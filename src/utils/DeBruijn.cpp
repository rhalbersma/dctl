...
/*
#include "../../DCTL/src/utils/DeBruijn.h"
...
template<>
const size_t DeBruijn<unsigned char>::TABLE[] = {
         0,  1,  6,  2,  7,  5,  4,  3
};
...
template<>
const size_t DeBruijn<unsigned short>::TABLE[] = {
         0,  1, 11,  2, 14, 12,  8,  3,
        15, 10, 13,  7,  9,  6,  5,  4
};
...
template<>
const size_t DeBruijn<unsigned int>::TABLE[] = {
         0,  1, 23,  2, 29, 24, 14,  3,
...
template<>
const size_t DeBruijn<unsigned __int64>::TABLE[] = {
         0,  1, 48,  2, 57, 49, 28,  3,
