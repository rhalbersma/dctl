...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::JUMPS, Rules, Board>::generate(const Position<Board>& p, capture::State<Rules, Board>& capture, Stack& moves)
{
...
template<bool Color, typename Rules, typename Board>
int Driver<Color, Material::KING, Move::JUMPS, Rules, Board>::count(const Position<Board>& p)
{
        Stack moves;
        generate(p, moves);
