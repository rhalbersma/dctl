...
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate(const Position<Board>& p, Stack& move_stack)
{
        generate_serial(unrestricted_kings<Rules>(p, Color), not_occupied(p), move_stack);
}

// tag dispatching based on restrictions on consecutive moves with the same king
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate_serial(BitBoard active_kings, BitBoard not_occupied, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate_serial(BitBoard active_kings, BitBoard not_occupied, Stack& move_stack, Int2Type<true>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate_serial(BitBoard active_kings, BitBoard not_occupied, Stack& move_stack, Int2Type<false>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate_dirs(BitBoard from_sq, BitBoard not_occupied, Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, Material::KING, Move::MOVES, Rules, Board>::generate_reverse(const Position<Board>& p, Stack& move_stack)
{
        generate_serial(p.kings(Color), not_occupied(p), move_stack);
}
