...
{
        generate_dir<Color, DirIndex<Color>::LU>(active_men, moves);
        generate_dir<Color, DirIndex<Color>::RU>(active_men, moves);
}
...
{
        return (
                count_dir<DirIndex<Color>::LU, Board>(active_men, not_occupied) +
                count_dir<DirIndex<Color>::RU, Board>(active_men, not_occupied)
        );
}
...
{
        return (
                detect_dir<DirIndex<Color>::LU, Board>(active_men, not_occupied) ||
                detect_dir<DirIndex<Color>::RU, Board>(active_men, not_occupied)
        );
}
