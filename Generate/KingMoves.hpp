...
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate(const Position<Board>& p, Propagate<Rules, Board>& moves)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_serial(BitBoard active_kings, Propagate<Rules, Board>& moves)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_serial(BitBoard active_kings, Propagate<Rules, Board>& moves, Int2Type<true>)
{
        while(active_kings) {
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_serial(BitBoard active_kings, Propagate<Rules, Board>& moves, Int2Type<false>)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_dirs(BitBoard from_sq, Propagate<Rules, Board>& moves)
{
...
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_dir(BitBoard from_sq, Propagate<Rules, Board>& moves)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_dir(BitBoard from_sq, Propagate<Rules, Board>& moves, Int2Type<RANGE_1>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::generate_dir(BitBoard from_sq, Propagate<Rules, Board>& moves, Int2Type<RANGE_N>)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::count(const Position<Board>& p)
{
        return count_dirs(p.template unrestricted_kings<Rules>(Color), p.not_occupied());
}

template<bool Color, typename Rules, typename Board> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::count_dirs(BitBoard active_kings, BitBoard not_occupied)
{
        return (
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::count_dir(BitBoard active_kings, BitBoard not_occupied)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::count_dir(BitBoard active_kings, BitBoard not_occupied, Int2Type<RANGE_1>)
{
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::count_dir(BitBoard active_kings, BitBoard not_occupied, Int2Type<RANGE_N>)
{
        return Bit::count(active_kings ^ Bit::flood_fill<DirTraits<Index>::IS_POSITIVE>(active_kings, not_occupied, Board::DIR[Index]));
}

template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::detect(const Position<Board>& p)
{
        assert(p.to_move() == Color);
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard not_occupied)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::MOVES, Color, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard not_occupied)
{
