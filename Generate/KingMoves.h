...
private:
        ...
        template<size_t> static void generate_dir(BitBoard, BitBoard, Move::List&, Int2Type<Variants::RANGE_1>);
        template<size_t> static void generate_dir(BitBoard, BitBoard, Move::List&, Int2Type<Variants::RANGE_N>);
