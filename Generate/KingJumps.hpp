...
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate(const Position<Board>& p, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate(const Position<Board>& p, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<true>)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_precede(const Position<Board>& p, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<false>)
{
        generate_serial(p.kings(Color), capture, move_stack);
}

template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_serial(BitBoard active_kings, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::DIRS_ALL>)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::DIRS_ORTH>)
{
...
template<bool Color, typename Rules, typename Board>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::DIRS_DIAG>)
{
...
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_dir(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
void Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::generate_next(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::promote_en_passant(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_next(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_next(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::RANGE_1>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_next(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::RANGE_N>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_long(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_long(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<false>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_long(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<true>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_reverse(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
        return scan_dir<Rotate<Index>::I180>(jumper, capture, move_stack);
}

template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_forward(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::SCAN_ALL>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::SCAN_REST>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack, Int2Type<Variants::SCAN_SIDE>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan_dir(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
        king_slide<Index>(jumper, capture.template path<Index>());
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Template<Color, Pieces::KING, Move::JUMPS, Rules, Board>::scan(BitBoard jumper, Capture::State<Rules, Board>& capture, Move::Stack& move_stack)
{
        if (jumper & capture.template targets<Index>()) {
                capture.make(jumper);
                generate_next<Index>(jumper, capture, move_stack);
