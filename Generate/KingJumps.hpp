...
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate(const Position<Board>& p, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_precede(const Position<Board>& p, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_precede(const Position<Board>& p, Propagate<Rules, Board>& capture, Int2Type<true>)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_precede(const Position<Board>& p, Propagate<Rules, Board>& capture, Int2Type<false>)
{
        generate_serial(p.kings(Color), capture);
}

template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_serial(BitBoard active_kings, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<DIRS_4>)
{
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<DIRS_8>)
{
        generate_dir<DirIndex<Board, Color>::LEFT_UP   >(jump_sq, capture);
        generate_dir<DirIndex<Board, Color>::RIGHT_UP  >(jump_sq, capture);
        generate_dir<DirIndex<Board, Color>::LEFT_DOWN >(jump_sq, capture);
...
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_1>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_N>)
{
...
void GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::generate_next(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
        ShiftAssign<DirTraits<Index>::IS_POSITIVE>()(jump_sq, Board::DIR[Index]);
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_next(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_next(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_1>)
{
        return (
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_next(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_N>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_long(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_long(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<false>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_long(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<true>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_reverse(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
        return scan_dir<RotateDirIndex<Index, D180>::VALUE>(jump_sq, capture);
}

template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_forward(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
// tag dispatching based on king capture directions
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
// partial specialization for kings that capture in the 4 diagonal directions
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<DIRS_4>)
{
        return (
...
// partial specialization for kings that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dirs(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<DIRS_8>)
{
        return (
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_1>)
{
        ShiftAssign<DirTraits<Index>::IS_POSITIVE>()(jump_sq, Board::DIR[Index]);
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan_dir(BitBoard jump_sq, Propagate<Rules, Board>& capture, Int2Type<RANGE_N>)
{
        do ShiftAssign<DirTraits<Index>::IS_POSITIVE>()(jump_sq, Board::DIR[Index]); while (jump_sq & capture.template path<Index>());
        return scan<Index>(jump_sq, capture);
}
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::scan(BitBoard target_sq, Propagate<Rules, Board>& capture)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::promotions_en_passant(BitBoard jump_sq, Propagate<Rules, Board>& capture)
{
        return scan_next<Index>(jump_sq, capture);
}

template<bool Color, typename Rules, typename Board> FORCE_INLINE
size_t GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::count(const Position<Board>& p)
{
        assert(p.to_move() == Color);
...
template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect(const Position<Board>& p)
{
        assert(p.to_move() == Color);
...
// tag dispatching based on king capture directions
template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied)
{
...
// partial specialization for kings that capture in the 4 diagonal directions
template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<DIRS_4>)
{
        return (
...
// partial specialization for kings that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dirs(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<DIRS_8>)
{
        return (
                detect_dir<DirIndex<Board, Color>::LEFT_UP   >(active_kings, opponent_pieces, not_occupied) ||
                detect_dir<DirIndex<Board, Color>::RIGHT_UP  >(active_kings, opponent_pieces, not_occupied) ||
...
// tag dispatching based on king range
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied)
{
...
// partial specialization for short ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<RANGE_1>)
{
...
// partial specialization for long ranged kings
template<bool Color, typename Rules, typename Board> template<size_t Index> FORCE_INLINE
bool GenerateDriver<Pieces::KING, Move::JUMPS, Color, Rules, Board>::detect_dir(BitBoard active_kings, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<RANGE_N>)
{
