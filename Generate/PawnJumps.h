...
private:
        ...
        static void generate_dirs(BitBoard, Capture::State<Rules, Board>&, Move::List&, Int2Type<Variant::DIRS_2>);
        ...
        template<size_t> static bool scan_next(BitBoard, Capture::State<Rules, Board>&, Move::List&, Int2Type<Variant::PROMOTE_BR>);
        template<size_t> static bool scan_next(BitBoard, Capture::State<Rules, Board>&, Move::List&, Int2Type<Variant::PROMOTE_EP>);

        // tag dispatching based on man capture directions
        template<size_t> static bool scan_dirs(BitBoard, Capture::State<Rules, Board>&, Move::List&);
        template<size_t> static bool scan_dirs(BitBoard, Capture::State<Rules, Board>&, Move::List&, Int2Type<Variant::DIRS_2>);
