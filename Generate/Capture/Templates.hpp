...
{
        return large<Rules>()(value, captured_pieces, Int2Type<Variants::is_MajorityPrecedence<Rules>::VALUE>());
}
...
{
        return Bit::count(captured_pieces) >= Variants::LargeCaptureValue<Rules>::VALUE;
}
...
{
        return value.num_pieces >= Variants::LargeCaptureValue<Rules>::VALUE;
}
