...
void Generate::generate(const Position<Board>& p, Propagate<Rules, Board>& moves)
{
        ...
        GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->generate(p, moves);
}
...
{
        assert(p.to_move() == Color);
        GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->generate_captures(p, moves);
}
...
{
        assert(p.to_move() == Color);
        GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->generate_promotions(p, moves);
}
...
{
        assert(p.to_move() == Color);
        return GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->count(p);
}
...
{
        assert(p.to_move() == Color);
        return GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->count_moves(p);
}
...
{
        assert(p.to_move() == Color);
        return GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->detect(p);
}
...
{
        assert(p.to_move() == Color);
        return GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->detect_captures(p);
}
...
{
        assert(p.to_move() == Color);
        GenerateFactory<Color, Rules, Board>::create(p.composition(Color))->detect_promotions(p);
}
