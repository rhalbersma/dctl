...
public:
        ...
        {
                return detect(p.pawns(Color), targets<Color, Rules>(p), not_occupied(p));
        }
...
private:
        ...
        static void generate(BitBoard active_pawns, State& capture, Stack& moves)
        {
        ...
        )
        {
                ...
                generate_dispatch(active_pawns, capture, moves, Int2Type<rules::dirs_diag>());
        }
        ...
        )
        {
                ...
                generate<Direction::right>(active_pawns, capture, moves);
                generate<Direction::up   >(active_pawns, capture, moves);
                generate<Direction::down >(active_pawns, capture, moves);
        }
        ...
        )
        {
                ...
                generate_dispatch(active_pawns, capture, moves, Int2Type<rules::dirs_down>());
        }
        ...
        )
        {
                ...
                generate<Direction::right_up>(active_pawns, capture, moves);
        }
        ...
        )
        {
                ...
                generate<Direction::right_down>(active_pawns, capture, moves);
        }
