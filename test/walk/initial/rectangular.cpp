...
typedef Fixture< Position<rules::International, board::Spantsireti> > SpantsiretiFixture;
BOOST_FIXTURE_TEST_CASE(SpantsiretiInitial, SpantsiretiFixture)
{
...
typedef Fixture< Position<rules::International, board::Ktar11> > Ktar11Fixture;
BOOST_FIXTURE_TEST_CASE(Ktar11Initial, Ktar11Fixture)
{
...
typedef Fixture< Position<rules::International, board::Ktar12> > Ktar12Fixture;
BOOST_FIXTURE_TEST_CASE(Ktar12Initial, Ktar12Fixture)
{
