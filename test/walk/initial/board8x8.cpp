...
typedef Fixture< Position<rules::Brazilian, board::Checkers> > BrazilianFixture;
...
typedef Fixture< Position<rules::Pool, board::Checkers> > PoolFixture;
...
typedef Fixture< Position<rules::Russian, board::Checkers> > RussianFixture;
...
typedef Fixture< Position<rules::Czech, board::Checkers> > CzechFixture;
...
typedef Fixture< Position<rules::Spanish, board::Roman> > SpanishFixture;
...
typedef Fixture< Position<rules::Italian, board::Roman> > ItalianFixture;
