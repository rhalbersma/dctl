...
BOOST_FIXTURE_TEST_CASE(Random178, Fixture)
{
...
BOOST_FIXTURE_TEST_CASE(Woldouby, Fixture)
{
        auto const p = setup::read<rules::International, board::International, pdn::protocol>()(
...
BOOST_AUTO_TEST_SUITE(TestPerftAlternative)
