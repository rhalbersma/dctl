...
{
        auto const p = setup::read<italian::Rules, board::Roman, pdn::protocol>()(
                "W:W30,26,27,22,23,24,17,18,20:B14,15,16,9,11,5,6,1,3"
        );
        std::size_t const leafs[] = { 5, 13, 42, 107, 360, 1'099, 3'736, 12'495, 43'686, 164'177, 628'686, 2'643'623, 10'833'722, 49'327'264, 212'130'912, 1'021'757'399 };
...
BOOST_AUTO_TEST_CASE(Gilbert2)
{
        ...
        std::size_t const leafs[] = { 6, 47, 271, 1'916, 10'810, 73'137, 389'809, 2'469'050, 12'803'372, 77'920'042, 396'940'628, 2'365'222'285 };
        test(p, duplicate_gen, leafs);
}
...
BOOST_AUTO_TEST_CASE(Gilbert3)
{
        ...
        std::size_t const leafs[] = { 13, 112, 828, 6'756, 46'241, 368'908, 2'468'110, 19'914'763, 130'562'037, 1'056'217'651, 6'894'949'061 };
        test(p, duplicate_gen, leafs);
}
*/
