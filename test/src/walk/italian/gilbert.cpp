...
BOOST_FIXTURE_TEST_CASE(Gilbert1, Fixture)
{
        ...
        std::size_t const leafs[] = { 5, 13, 42, 107, 360, 1099, 3736, 12495, 43686, 164177, 628686, 2643623, 10833722, 49327264, 212130912, 1021757399 };
        run(p, leafs);
}
...
BOOST_FIXTURE_TEST_CASE(Gilbert2, Fixture)
{
        ...
        std::size_t const leafs[] = { 6, 47, 271, 1916, 10810, 73137, 389809, 2469050, 12803372, 77920042, 396940628, 2365222285 };
        run(p, leafs);
}
...
BOOST_FIXTURE_TEST_CASE(gilbert3, Fixture)
{
        ...
        std::size_t const leafs[] = { 13, 112, 828, 6756, 46241, 368908, 2468110, 19914763, 130562037, 1056217651, 6894949061 };
        run(p, leafs);
}
*/
