...
{
        auto const p = Position<pool::Rules, board::Checkers>::initial();
...
{
        auto const p = Position<russian::Rules, board::Checkers>::initial();
...
{
        auto const p = Position<checkers::Rules, board::Checkers>::initial();
...
{
        auto const p = Position<czech::Rules, board::Checkers>::initial();
...
{
        auto const p = Position<spanish::Rules, board::Roman>::initial();
...
{
        auto const p = Position<italian::Rules, board::Roman>::initial();
...
{
        auto const p = Position<thai::Rules, board::Checkers>::initial(2);
