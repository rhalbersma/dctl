...
{
        auto const p = setup::read<international::Rules, board::International, pdn::protocol>()(
                "B:BK17,K24:W6,9,10,11,20,21,22,23,30,K31,33,37,41,42,43,44,46"
        );
        std::size_t const leafs[] = { 14, 55, 1'168, 5'432, 87'195, 629'010, 9'041'010, 86'724'219, 1'216'917'193 };
...
BOOST_AUTO_TEST_CASE(Woldouby)
{
        ...
        std::size_t const leafs[] = { 6, 12, 30, 73, 215, 590, 1'944, 6'269, 22'369, 88'050, 377'436, 1'910'989, 9'872'645, 58'360'286, 346'184'885 };
        test(p, unique_gen, leafs);
}
...
BOOST_AUTO_TEST_CASE(AllKings)
{
        ...
        std::size_t const leafs[] = { 17, 79, 352, 1'399, 7'062, 37'589, 217'575, 1'333'217, 8'558'321, 58'381'162, 417'920'283 };
        test(p, unique_gen, leafs);
}
...
BOOST_AUTO_TEST_CASE(AlmostPromotion)
{
        ...
        std::size_t const leafs[] = { 9, 81, 795, 7'578, 86'351, 936'311, 11'448'262, 138'362'698, 1'799'526'674 };
        test(p, unique_gen, leafs);
}
