...
BOOST_AUTO_TEST_CASE(Brazilian)
{
        ...
        auto const s = basic_state<brazilian, basic_board<rectangular<8, 8>>>::initial();
...
BOOST_AUTO_TEST_CASE(Pool)
{
        ...
        auto const s = basic_state<pool, basic_board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Russian)
{
        ...
        auto const s = basic_state<russian, basic_board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Checkers)
{
        ...
        auto const s = basic_state<checkers, basic_board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
