...
BOOST_AUTO_TEST_CASE(Brazilian)
{
        ...
        auto const s = basic_state<brazilian, board<rectangular<8, 8>>>::initial();
...
BOOST_AUTO_TEST_CASE(Pool)
{
        ...
        auto const s = basic_state<pool, board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Russian)
{
        ...
        auto const s = basic_state<russian, board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Checkers)
{
        ...
        auto const s = basic_state<checkers, board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Czech)
{
        ...
        auto const s = basic_state<czech, board<rectangular<8, 8>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Spanish)
{
        ...
        auto const s = basic_state<spanish, board<rectangular<8, 8, true>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Italian)
{
        ...
        auto const s = basic_state<italian, board<rectangular<8, 8, true>>>::initial();
        auto const leafs = std::vector<std::vector<int64_t>> {
...
BOOST_AUTO_TEST_CASE(Thai)
{
        ...
        auto const s = basic_state<thai, board<rectangular<8, 8>>>::initial(2);
        auto const leafs = std::vector<std::vector<int64_t>> {
