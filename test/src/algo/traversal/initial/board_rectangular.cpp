...
{
        auto const state = basic_state<international, basic_board<spantsiretti>>::initial();
...
{
        auto const state = basic_state<international, basic_board<ktar< 8, 10>>>::initial();
        auto const leafs = std::vector<int64_t>
...
{
        auto const state = basic_state<international, basic_board<ktar<10,11>>>::initial();
        auto const leafs = std::vector<int64_t>
...
{
        auto const state = basic_state<international, basic_board<ktar<10,12>>>::initial();
        auto const leafs = std::vector<int64_t>
...
{
        auto const state = basic_state<international, basic_board<rectangular<12,10>>>::initial();
        auto const leafs = std::vector<int64_t>
