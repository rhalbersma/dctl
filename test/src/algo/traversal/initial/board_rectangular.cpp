...
{
        auto const s = basic_state<international, board<spantsiretti>>::initial();
...
{
        auto const s = basic_state<international, board<ktar< 8, 10>>>::initial();
...
{
        auto const s = basic_state<international, board<ktar<10,11>>>::initial();
...
{
        auto const s = basic_state<international, board<ktar<10,12>>>::initial();
...
{
        auto const s = basic_state<international, board<rectangular<12,10>>>::initial();
