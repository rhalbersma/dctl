...
{
        auto const p = state<international, rectangular<spantsiretti>>::initial();
...
{
        auto const p = state<international, rectangular<ktar<10,11>>>::initial();
...
BOOST_AUTO_TEST_CASE(ktar10x12)
{
        ...
        auto const q = state<international, rectangular<ktar<10,12>>>::initial();
...
BOOST_AUTO_TEST_CASE(Board12x10)
{
        ...
        auto const q = state<international, rectangular<pack<12,10>>>::initial();
        traversal::test(drop_duplicates_gen, q, leafs);
}
