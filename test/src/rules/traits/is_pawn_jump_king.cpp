#include <dctl/rules/traits/is_pawn_jump_king.hpp>      // is_pawn_jump_king_v
...
using VariantsTrue = boost::mpl::vector<
        AKWDamme, Checkers, Czech, Frisian, HHoogland, International, Killer, Pool, Russian, Spanish, Thai
>;
