...
#include <dctl/rule_traits.hpp>         // is_backward_pawn_jump, king_range_category, long_ranged_tag, is_less, initial_gap, is_land_behind_piece, is_en_passant_jump_removal
