...
BOOST_FIXTURE_TEST_CASE(TestKingCaptureDirection, FixtureItalian)
{
        ...
        std::string legal[] = { "22x13", "22x15", "22x31" };                
        run(FEN, legal);
}
