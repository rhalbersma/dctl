...
struct detector<Color, Material::both, select::reverse, Position, Range>
{
private:
        // typedefs
        ...
        typedef detector<Color, Material::pawn, select::reverse, Position, rules::range::distance_1> PawnMoves;
        typedef detector<Color, Material::king, select::reverse, Position, rules::range::distance_1> KingMoves;
