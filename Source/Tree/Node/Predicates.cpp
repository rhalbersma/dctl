...
bool tree::node::is_intersecting_capture(BitBoard delta, BitBoard captured_pieces, Int2Type<variants::REMOVE_1>)
{
...
bool tree::node::is_intersecting_capture(BitBoard, BitBoard, Int2Type<variants::REMOVE_N>)
{
        return false; 
}

// specialization for men that promote on the back row
bool tree::node::is_intersecting_promotion(BitBoard, BitBoard, Int2Type<variants::PROMOTE_BR>)
{
        return false;
}

// specialization for men that promote en-passant (Russian draughts)
bool tree::node::is_intersecting_promotion(BitBoard promotion, BitBoard delta, Int2Type<variants::PROMOTE_EP>)
{
