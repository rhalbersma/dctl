...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::generate_dirs(BitBoard active_men, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::DIRS_ALL>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::generate_dirs(BitBoard active_men, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::DIRS_ORTH>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::generate_dirs(BitBoard active_men, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::DIRS_DIAG>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::generate_dirs(BitBoard active_men, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::DIRS_UP>)
{
...
template<bool Color, typename Rules, typename Board>
void Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::generate_dirs(BitBoard active_men, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::DIRS_DOWN>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::PROMOTE_EP>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_next(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::PROMOTE_BR>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::SCAN_ALL>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::SCAN_REST>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::SCAN_SIDE>)
{
        return (
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::SCAN_UP>)
{
...
template<bool Color, typename Rules, typename Board> template<size_t Index>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::scan_dirs(BitBoard jumper, capture::State<Rules, Board>* capture, node::Stack* move_stack, Int2Type<variants::SCAN_DOWN>)
{
...
// partial specialization for men that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_men, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<variants::DIRS_ALL>)
{
        return (
...
// partial specialization for men that capture in the 8 diagonal and orthogonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_men, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<variants::DIRS_ORTH>)
{
        return (
...
// partial specialization for men that capture in the 4 diagonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_men, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<variants::DIRS_DIAG>)
{
        return (
...
// partial specialization for men that capture in the 2 forward diagonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_men, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<variants::DIRS_UP>)
{
        return (
...
// partial specialization for men that capture in the 2 backward diagonal directions
template<bool Color, typename Rules, typename Board>
bool Driver<Color, node::Pieces::PAWN, node::JUMPS, Rules, Board>::detect_dirs(BitBoard active_men, BitBoard opponent_pieces, BitBoard not_occupied, Int2Type<variants::DIRS_DOWN>)
{
        return (
