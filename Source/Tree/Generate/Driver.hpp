...
void Driver<Color, Material, MoveType, Rules, Board>::generate(const node::Position<Board>&, move::Stack*) 
{ 
...
template<bool Color, int Material, move::Type MoveType, typename Rules, typename Board>
void Driver<Color, Material, MoveType, Rules, Board>::generate_promotions(const node::Position<Board>&, move::Stack*) 
{ 
        static_assert(Material == node::Pieces::NONE, "Template function already defined.");
        return;
}
