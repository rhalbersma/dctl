...
private:
        ...
        static void generate_dirs(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::DIRS_UP  >);
        static void generate_dirs(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::DIRS_DOWN>);
        ...
        template<size_t> static bool scan_next(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::PROMOTE_BR>);
        template<size_t> static bool scan_next(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::PROMOTE_EP>);
        ...
        template<size_t> static bool scan_dirs(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::SCAN_UP  >);
        template<size_t> static bool scan_dirs(BitBoard, capture::State<Rules, Board>&, node::Stack&, Int2Type<variants::SCAN_DOWN>);
