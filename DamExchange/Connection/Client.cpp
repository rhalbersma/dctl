...
void Layer1::Client::connect(const std::string& host_name, const std::string& service_name)
{
...
void Layer1::Client::async_connect_next(tcp::resolver::iterator endpoint_iterator)
{
...
void Layer1::Client::handle_connect(const boost::system::error_code& error, tcp::resolver::iterator endpoint_iterator)
{
        if (!error) {
                async_read_next();
...
void Layer1::Client::accept(const std::string& service_name)
{
...
void Layer1::Client::handle_accept(const boost::system::error_code& error)
{
        if (!error) {
                async_read_next();
        }
...
std::string Layer1::Client::read(void)
{
...
void Layer1::Client::async_read_next(void)
{
...
void Layer1::Client::handle_read(const boost::system::error_code& error)
{
        if (!error) {
...
void Layer1::Client::write(const std::string& msg)
{
...
void Layer1::Client::do_write(std::string msg)
{
...
void Layer1::Client::async_write_next(void)
{
...
void Layer1::Client::handle_write(const boost::system::error_code& error)
{
        if (!error) {
...
void Layer1::Client::do_close(void)
{
        socket_.close();
}
