...
template<>
struct equal_to<Frisian>: public std::binary_function<CaptureValue, CaptureValue, bool>
{
...
template<>
struct greater_equal<Frisian>: public std::binary_function<CaptureValue, CaptureValue, bool>
{
        bool operator()(const CaptureValue& left, const CaptureValue& right) const
        {
